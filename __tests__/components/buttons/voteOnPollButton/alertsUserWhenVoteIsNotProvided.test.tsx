import { newPollVoteNoVoteHandler } from '@/../__mocks__/newPollVote/errorHandlers';
...
test.skip('alerts user when vote is not provided', async () => {
  server.use(...newPollVoteNoVoteHandler);
  ...
  const toast = await screen.findByText(/Vote option must be provided/i);
