...
// scenario A in this document: https://docs.google.com/document/d/1C_CFtStp43ZPr_O13j-J34XtZvz8jXmj60IfdT3IUO8/edit?tab=t.0#heading=h.gjdgxs
test('constitution approved', async () => {
  const votes = {
    yes: [
